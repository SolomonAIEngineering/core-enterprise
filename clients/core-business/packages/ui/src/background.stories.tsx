        ...
        <div className="relative min-h-screen">
            ...
            <div className="relative z-10 p-8">
                <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="rounded-lg bg-white/80 p-6 shadow-lg backdrop-blur">
            ...
            <div className="relative z-10 flex">
                <aside className="w-64 border-r border-gray-200 bg-white/80 p-4 backdrop-blur">
                    <nav className="space-y-2">
                        <a href="/menu-1" className="block rounded p-2 hover:bg-gray-100">Menu Item 1</a>
                        <a href="/menu-2" className="block rounded p-2 hover:bg-gray-100">Menu Item 2</a>
                        <a href="/menu-3" className="block rounded p-2 hover:bg-gray-100">Menu Item 3</a>
                    </nav>
                </aside>
        ...
        <div className="relative min-h-screen">
            ...
            <div className="relative z-10 flex min-h-[70vh] items-center justify-center">
                <div className="text-center">
                    ...
                    <button type="button" className="mt-8 rounded-full bg-blue-500 px-8 py-3 text-white hover:bg-blue-600">
                        Call to Action
                    </button>
                </div>
            </div>
