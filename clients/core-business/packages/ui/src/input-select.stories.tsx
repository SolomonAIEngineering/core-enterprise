...
const meta: Meta<typeof InputSelect> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A searchable select input component with customizable options and mobile support.'
            },
        },
    },
};
...
const itemsWithImages = [
    { id: '1', value: 'Profile 1', image: 'https://avatars.githubusercontent.com/u/1' },
    { id: '2', value: 'Profile 2', image: 'https://avatars.githubusercontent.com/u/2' },
    { id: '3', value: 'Profile 3', image: 'https://avatars.githubusercontent.com/u/3' },
];

export const Default: Story = {
    render: () => {
        const [selectedItem, setSelectedItem] = useState<InputSelectItemProps | null>(null);
        return (
            <InputSelect
                items={sampleItems}
