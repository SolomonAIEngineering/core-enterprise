...
const meta: Meta<typeof CopyText> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A text component that copies its content to clipboard when clicked.'
            },
        },
    },
};
...
export const Default: Story = {
    render: () => (
        <CopyText value="Text to copy">Click to copy</CopyText>
    ),
};
...
export const InParagraph: Story = {
    render: () => (
        <p className="max-w-md text-gray-600">
            ...
            {' '}
            <CopyText value="copyable text">copyable text</CopyText>
            {' '}
            that can be clicked to copy.
        </p>
    ),
};
...
export const WithTooltip: Story = {
    render: () => (
        <div className="group relative">
            <CopyText value="Hover to see tooltip">
                Hover over me
            </CopyText>
