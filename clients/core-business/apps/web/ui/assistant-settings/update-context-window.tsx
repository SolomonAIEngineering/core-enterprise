...
const CONTEXT_WINDOW_OPTIONS: ComboboxOption<{ description: string }>[] = [
  { label: "1 Message", value: "1", meta: { description: "Only consider the last message" } },
  { label: "2 Messages", value: "2", meta: { description: "Consider the last two messages" } },
  { label: "4 Messages", value: "4", meta: { description: "Balanced context (Recommended)" } },
  { label: "6 Messages", value: "6", meta: { description: "Extended context" } },
