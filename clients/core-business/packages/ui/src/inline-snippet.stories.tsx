...
export const Default: Story = {
    render: () => (
        <InlineSnippet>npm install @package/name</InlineSnippet>
    ),
};
...
export const WithCustomStyling: Story = {
    render: () => (
        <InlineSnippet className="bg-blue-50 text-blue-700 border-blue-200">
...
export const InParagraph: Story = {
    render: () => (
        <p className="max-w-2xl text-gray-600">
            ...
            <InlineSnippet>npm install</InlineSnippet>
            {' '}in your terminal. For development, you might want to use{' '}
            <InlineSnippet>npm install --save-dev</InlineSnippet>
            {' '}instead.
        </p>
    ),
};
