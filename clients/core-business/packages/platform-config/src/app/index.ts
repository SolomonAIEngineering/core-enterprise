...
const emailConfig: EmailConfig = {
  from: {
    default: "Yoan from Vector <yoan@ship.getvector.app>",
    support: "Vector Support <support@ship.getvector.app>",
    sales: "Vector Sales <sales@ship.getvector.app>",
    billing: "Vector Billing <billing@ship.getvector.app>",
    notifications: "Vector Notifications <notifications@ship.getvector.app>",
    system: "Vector <system@ship.getvector.app>",
  },
  replyTo: "support@ship.getvector.app",
  templates: {
...
export const BusinessConfig: SiteConfig = {
  ...
  supportEmail: "support@ship.getvector.app",
