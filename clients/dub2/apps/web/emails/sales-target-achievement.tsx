  ...
  return (
    <Html>
      ...
      <Preview>
        ...
        {Math.round(
          (achievement.achieved.revenue / achievement.target.revenue) * 100,
        ).toString()}
        % of target)
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              Congratulations on your outstanding performance for{" "}
              {achievement.period}! Your team has demonstrated exceptional
              execution, surpassing key targets and setting new benchmarks for
              success.
            </Text>
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              Your team has shown remarkable performance across all key metrics.
              These achievement rates reflect the dedication and effectiveness
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              These achievements showcase the effectiveness of your team's
              execution and highlight areas of exceptional performance that can
            ...
            <Section className="my-4">
              <div className="rounded-lg border border-solid border-gray-200 p-4">
                {achievement.highlights.map((highlight, index) => (
                  <Text
                    key={`${index}-${highlight}-${Math.random()}`}
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              Recognition of outstanding individual performances who have
              significantly contributed to exceeding our targets. Their
              strategies and best practices can serve as valuable examples for
              the entire team.
            </Text>
            <Section className="my-4">
              <div className="rounded-lg border border-solid border-gray-200 p-4">
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              Building on this success, we've set ambitious but achievable
              targets for the next period. These goals reflect our growth
              trajectory and market opportunities.
            </Text>
            <Section className="my-4">
              <div className="rounded-lg border border-solid border-gray-200 p-4">
                <Row>
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              To achieve our next period goals, we've identified key focus areas
              that align with our growth strategy and market opportunities.
            </Text>
            <Section className="my-4">
              <div className="rounded-lg border border-solid border-gray-200 p-4">
                {achievement.nextPeriod.focus.map((focus, index) => (
                  <Text
                    key={`${index}-${focus}-${Math.random()}`}
                    className="m-0 mb-2 text-sm"
                  >
                    {index + 1}. {focus}
                  </Text>
            ...
            <Text className="mb-4 mt-8 text-sm leading-6 text-black">
              Congratulations again on this outstanding achievement! Let's
              maintain this momentum and continue driving towards our ambitious
