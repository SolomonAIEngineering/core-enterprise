...
const meta: Meta<typeof Sheet> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A sheet component that slides in from the side with customizable content.'
            },
        },
    },
};
...
export const Default: Story = {
    render: () => {
        ...
        return (
            <>
                <Button onClick={() => setOpen(true)} variant="secondary" className="w-full bg-primary text-secondary">Open Sheet</Button>
            ...
            <>
                ...
                <Sheet open={parentOpen} onOpenChange={setParentOpen}>
                    <div className="p-6">
                        ...
                        <div className="mt-4">
                            <Button onClick={() => setChildOpen(true)}>Open Child Sheet</Button>
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <div className="p-6">
                        <Sheet.Title className="text-purple-800">Custom Styled Sheet</Sheet.Title>
