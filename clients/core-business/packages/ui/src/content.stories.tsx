...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Content lists and configurations used throughout the application.'
            },
        },
    },
} satisfies Meta;
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {FEATURES_LIST.map((feature) => (
                    ...
                    >
                        ...
                        <h3 className="mb-2 font-medium group-hover:text-blue-500">{feature.title}</h3>
                        <p className="text-sm text-gray-600">{feature.description}</p>
                    </div>
                ))}
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {RESOURCES.map((resource) => (
                    ...
                    >
                        ...
                        <h3 className="mb-2 font-medium group-hover:text-blue-500">{resource.title}</h3>
                        <p className="text-sm text-gray-600">{resource.description}</p>
                    </div>
                ))}
            </div>
