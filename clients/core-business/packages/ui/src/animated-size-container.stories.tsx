        ...
        return (
            <div>
                ...
                <AnimatedSizeContainer width>
                    <div className="rounded border border-gray-200 p-4">
                        <p>{expanded ? 'This is a longer text that expands the width smoothly' : 'Short text'}</p>
                    </div>
                </AnimatedSizeContainer>
            </div>
        );
            ...
            <div>
                ...
                <AnimatedSizeContainer height>
                    <div className="rounded border border-gray-200">
                        {items.map((item) => (
                            <div key={item} className="border-b border-gray-200 p-4 last:border-none">
                                Item {item}
                            </div>
                        ))}
                    </div>
                ...
                <div className="mb-4 flex space-x-2">
                    {[1, 2, 3].map((tab) => (
                        <button
                            ...
                            className={`rounded px-4 py-2 ${activeTab === tab
        ...
        return (
            <div className="w-[300px]">
                <div className="space-y-4 rounded border border-gray-200 p-4">
                    <div>
                        <label htmlFor="required-field" className="block text-sm font-medium text-gray-700">Required Field</label>
                        <input id="required-field" type="text" className="mt-1 block w-full rounded border p-2" />
                    </div>
                    ...
                    <AnimatedSizeContainer height>
                        {showOptional && (
                            <div className="space-y-4">
                                <div>
                                    <label htmlFor="optional-field-1" className="block text-sm font-medium text-gray-700">Optional Field 1</label>
                                    <input id="optional-field-1" type="text" className="mt-1 block w-full rounded border p-2" />
                                </div>
                                <div>
                                    <label htmlFor="optional-field-2" className="block text-sm font-medium text-gray-700">Optional Field 2</label>
