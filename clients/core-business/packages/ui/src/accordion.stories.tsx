    ...
    render: () => (
        <Accordion type="single" className="w-[400px]">
            <AccordionItem value="item-1">
                ...
                <AccordionContent>Using the plus icon variant instead of chevron.</AccordionContent>
            </AccordionItem>
        </Accordion>
    ),
};
    ...
    render: () => (
        <Accordion type="single" className="w-[400px]">
            <AccordionItem value="item-1" className="border-blue-200">
                <AccordionTrigger className="text-blue-600">Custom Styled</AccordionTrigger>
    ...
    render: () => (
        <Accordion type="single" className="w-[400px]">
            <AccordionItem value="item-1">
                ...
                <AccordionContent>
                    Content with icons in the trigger.
                </AccordionContent>
            </AccordionItem>
        </Accordion>
    ),
