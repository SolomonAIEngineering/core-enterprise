import { ContentIcon, ContentLinkCard, LargeLinkCard, ToolLinkCard } from './shared';
...
const meta: Meta<typeof ContentLinkCard> = {
    parameters: {
        ...
        docs: {
            description: {
                component: 'Navigation content components used in dropdown menus and navigation panels.'
            },
        },
    },
    tags: ['autodocs'],
