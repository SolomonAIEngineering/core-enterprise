    ...
    render: () => {
        ...
        return (
            <RadioGroup value={value} onValueChange={setValue}>
                ...
                <div className="flex items-start space-x-2">
                    <RadioGroupItem value="performance" id="performance" className="mt-1" />
                    <div>
                        <Label htmlFor="performance">Performance</Label>
                        <p className="text-sm text-gray-500">Maximum speed and responsiveness</p>
                    </div>
                </div>
            </RadioGroup>
        );
        ...
        return (
            <RadioGroup value={value} onValueChange={setValue}>
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="option2-disabled" className="text-gray-400">Disabled Option</Label>
                </div>
            </RadioGroup>
        );
    },
                ...
                {['card1', 'card2'].map((card) => (
                    ...
                    `}>
                        <div className="flex items-start space-x-2">
                            ...
                            <div>
                                <Label htmlFor={card}>Card {card === 'card1' ? 'One' : 'Two'}</Label>
                                <p className="text-sm text-gray-500">Description for {card === 'card1' ? 'first' : 'second'} card</p>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <RadioGroup value={value} onValueChange={setValue} className="grid grid-cols-2 gap-4">
                ...
                `}>
                    <div className="flex flex-col items-center space-y-2">
                        <div className="w-full h-24 bg-white border rounded-md" />
                        <div className="flex items-center space-x-2">
                ...
                `}>
                    <div className="flex flex-col items-center space-y-2">
                        <div className="w-full h-24 bg-gray-900 border rounded-md" />
                        <div className="flex items-center space-x-2">
