...
const meta: Meta<typeof Modal> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A versatile modal component with mobile drawer support and customizable content.'
            },
        },
    },
};
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <div className="p-8">
                        <h2 className="text-2xl font-bold text-purple-800 mb-4">Custom Styled Modal</h2>
...
export const PreventDefaultClose: Story = {
    render: () => {
        ...
        return (
            <>
                <Button onClick={() => setShowModal(true)}>Modal with Prevent Close</Button>
                <Modal
                    showModal={showModal}
                    setShowModal={setShowModal}
                    preventDefaultClose
                >
                    <div className="p-6">
                        <h2 className="text-xl font-bold mb-4">Cannot Close by Default</h2>
                        <p className="text-gray-600 mb-4">This modal prevents default closing behavior.</p>
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <div className="p-6">
                        <h2 className="text-xl font-bold mb-4">Desktop Only Modal</h2>
                        <p className="text-gray-600">This modal only shows on desktop devices.</p>
                    </div>
                </Modal>
            </>
        );
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <div className="p-6">
                        <h2 className="text-xl font-bold mb-4">Wide Modal</h2>
                        <p className="text-gray-600">This modal has a custom maximum width applied.</p>
                    </div>
                </Modal>
            </>
        );
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <div className="p-6">
                        <h2 className="text-xl font-bold mb-4">Custom Close Handler</h2>
                        <p className="text-gray-600">This modal has a custom close handler.</p>
                    </div>
                </Modal>
            </>
        );
