  ...
  return (
    <div className="w-full overflow-hidden border border-gray-200 bg-white sm:rounded-xl">
          ...
          {tabs.map(({ id, label, colorClassName }, idx) => {
            return (
              <div key={id} className="relative z-0">
                ...
                {id === "sales" && (
                  <ToggleGroup
                    className="absolute right-3 top-3 hidden w-fit shrink-0 items-center gap-1 border-neutral-100 bg-neutral-50 sm:flex"
      ...
      <div className="relative">
        ...
        {showConversions && (
          <ToggleGroup
            className="absolute right-3 top-3 flex w-fit shrink-0 items-center gap-1 border-neutral-100 bg-neutral-50"
            optionClassName="size-8 p-0 flex items-center justify-center"
            indicatorClassName="border border-neutral-200 bg-white"
            options={[
              {
