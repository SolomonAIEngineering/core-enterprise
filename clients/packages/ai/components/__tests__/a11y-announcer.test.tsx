...
describe('AccessibilityAnnouncer', () => {
    ...
    it('updates message when prop changes', () => {
        const { rerender } = render(<AccessibilityAnnouncer message="Initial message" />);
    ...
    it('handles assertive aria-live', () => {
        render(<AccessibilityAnnouncer message="Test message" ariaLive="assertive" />);
    ...
    it('applies correct visibility classes', () => {
        const { container } = render(<AccessibilityAnnouncer message="Test message" />);
    ...
    it('cleans up timeout on unmount', () => {
        const { unmount } = render(<AccessibilityAnnouncer message="Test message" />);
