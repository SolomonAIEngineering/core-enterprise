...
const AMOUNT_LIMIT_OPTIONS: ComboboxOption<{ description: string }>[] = [
    { label: "No Limit", value: "0", meta: { description: "No minimum or maximum amount" } },
    { label: "$10", value: "10", meta: { description: "Minimum transaction amount" } },
    { label: "$50", value: "50", meta: { description: "Standard minimum amount" } },
    { label: "$100", value: "100", meta: { description: "Higher minimum amount" } },
    { label: "$1,000", value: "1000", meta: { description: "Maximum transaction amount" } },
    { label: "$5,000", value: "5000", meta: { description: "Higher maximum amount" } },
    { label: "$10,000", value: "10000", meta: { description: "Very high maximum amount" } },
];
        ...
        >
            <div className="flex flex-col space-y-3 p-5 sm:p-10">
                ...
                <div className="w-full max-w-md space-y-4">
                    <div>
                        <label className="text-sm font-medium text-gray-700">Minimum Transaction Amount</label>
                    ...
                    <div>
                        <label className="text-sm font-medium text-gray-700">Maximum Transaction Amount</label>
