...
import { d } from '@dub/utils/dist/pricing-509284b9';
...
const meta: Meta<typeof Avatar> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Avatar component that displays user images with fallback support.'
            },
        },
    },
};
...
export const TokenAvatarCustomSize: Story = {
    render: () => (
        <TokenAvatar id="large-token" className="h-16 w-16" />
    ),
};
