...
const meta: Meta<typeof Popover> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A flexible popover component with mobile drawer support and customizable content.'
            },
        },
    },
};
            ...
            <Popover
                content={
                    <div className="p-4 space-y-4">
                        ...
                        <p className="text-gray-600">This is a detailed description with rich content.</p>
...
export const WithEscapeHandler: Story = {
    render: () => {
        ...
        return (
            ...
            >
                <Button onClick={() => setOpenPopover(true)}>With Escape Handler</Button>
            </Popover>
        );
    },
};
