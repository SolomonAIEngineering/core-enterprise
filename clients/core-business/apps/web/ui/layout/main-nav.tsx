  ...
  return (
    <div className="h-screen md:grid md:grid-cols-[240px_minmax(0,1fr)] md:py-[2%] md:pl-[2%]">
      ...
      <div className="h-screen bg-neutral-50 md:pb-1.5">
        <div className="dub-scrollbar border-3 bg-background text-card-foreground border-gray-150 relative h-[calc(100vh-4rem)] overflow-hidden rounded-2xl bg-neutral-50 pt-px shadow-xl md:m-[1%] md:bg-white scrollbar-hide">
