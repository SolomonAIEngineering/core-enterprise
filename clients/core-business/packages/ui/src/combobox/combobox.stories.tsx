...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A versatile combobox component that supports single and multiple selection, search functionality, custom option creation, and rich customization options.'
            },
        },
    },
    tags: ['autodocs'],
...
const ComboboxWithState = (args: Partial<Parameters<typeof Combobox>[0]>) => {
    const [selected, setSelected] = useState<ComboboxOption[] | ComboboxOption | null>(
        args.multiple ? [] : null
    );
    return (
