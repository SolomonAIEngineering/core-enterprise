...
const meta: Meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A collection of custom icons used throughout the application, including social media, tech stacks, loading states, and more.'
            },
        },
    },
    tags: ['autodocs'],
...
const IconDisplay = ({ name, Icon }: { name: string; Icon: ComponentType<{ className: string }> }) => (
    <div className="flex flex-col items-center justify-center p-4 m-2 border rounded-lg hover:bg-gray-50 transition-colors">
...
const IconGrid = ({ icons }: { icons: Record<string, ComponentType<{ className: string }>> }) => (
