...
export const Large: Story = {
    render: () => (
        <CompositeLogo className="h-12" />
    ),
};

export const Small: Story = {
    render: () => (
        <CompositeLogo className="h-4" />
    ),
};

export const CustomColor: Story = {
    render: () => (
        <CompositeLogo className="text-blue-500" />
    ),
};
...
export const Responsive: Story = {
    render: () => (
        <CompositeLogo className="h-4 sm:h-6 md:h-8 lg:h-10" />
    ),
}; 