...
const meta: Meta<typeof EmptyState> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'An empty state component for displaying when there is no content.'
            },
        },
    },
};
...
export const WithCustomButton: Story = {
    render: () => (
        ...
        >
            <button type="button" className="mt-4 rounded-md bg-blue-500 px-4 py-2 text-sm text-white hover:bg-blue-600">
                Refresh inbox
            </button>
        </EmptyState>
    ),
...
export const UsersExample: Story = {
    render: () => (
        ...
        >
            <button type="button" className="mt-4 rounded-md border border-gray-300 px-4 py-2 text-sm hover:bg-gray-50">
                Invite members
            </button>
        </EmptyState>
    ),
...
export const ErrorExample: Story = {
    render: () => (
        ...
        >
            <button type="button" className="mt-4 rounded-md bg-red-500 px-4 py-2 text-sm text-white hover:bg-red-600">
                Try again
            </button>
        </EmptyState>
    ),
    ...
    render: () => (
        ...
        >
            <div className="mt-4 space-x-3">
                <button type="button" className="rounded-md bg-blue-500 px-4 py-2 text-sm text-white hover:bg-blue-600">
                    Connect database
                </button>
                <button type="button" className="rounded-md border border-gray-300 px-4 py-2 text-sm hover:bg-gray-50">
                    View documentation
                </button>
            </div>
        </EmptyState>
