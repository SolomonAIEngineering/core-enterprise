...
export const contentLinkCardClassName =
  'group rounded-[8px] p-2 transition-colors hover:bg-neutral-50 active:bg-neutral-50 dark:hover:bg-white/[0.15] dark:active:bg-white/20'
...
export function LargeLinkCard({
  ...
  return (
    <Link
      {...rest}
      className="group relative flex flex-col rounded-xl border border-neutral-100 bg-neutral-50 transition-colors duration-150 hover:bg-neutral-50 active:bg-neutral-200 dark:border-white/20 dark:bg-white/10 dark:hover:bg-white/15 dark:active:bg-white/20"
    >
