...
const meta: Meta<typeof StatusBadge> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A status badge component with various styles and icon support.'
            },
        },
    },
};
...
export const Compact: Story = {
    render: () => (
        <div className="space-y-4">
            <StatusBadge variant="success" className="text-xs px-1.5 py-0.5">
                Compact Success
            </StatusBadge>
            <StatusBadge variant="warning" className="text-xs px-1.5 py-0.5">
                Compact Warning
            </StatusBadge>
            <StatusBadge variant="error" className="text-xs px-1.5 py-0.5">
                Compact Error
            </StatusBadge>
        </div>
    ),
