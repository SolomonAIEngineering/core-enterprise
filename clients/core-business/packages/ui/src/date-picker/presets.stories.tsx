...
import { startOfToday, subDays, addMonths } from 'date-fns';
...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'A component for displaying and selecting date presets with keyboard shortcuts and tooltips.'
            },
        },
    },
    tags: ['autodocs'],
